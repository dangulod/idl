...
namespace idl
{
    ...
    private:
        ...
        void v_cwi(arma::cube *r,
                   ...
                   size_t id,
                   size_t n_threads);
        void v_component_loss(arma::cube *r,
                              size_t n,
                              size_t n_replenishment,
                              size_t seed,
                              ...
                              size_t id,
                              size_t n_threads);
        void v_component_loss_scen(arma::cube *r,
        ...
        arma::sp_mat id_component_loss(size_t n_replenishment,
                                    ...
                                    bool hedge,
                                    size_t id);
        arma::vec id_total_loss(size_t n_replenishment,
                                size_t seed,
                                std::vector<double> times,
                                double liquidity_horizon,
                                bool diversification,
    ...
    public:
        ...
        arma::sp_mat component_loss(arma::mat f,
                                  ...
                                  bool hedge = true);
        arma::cube component_loss(size_t n,
                                  size_t n_replenishment,
                                  size_t seed,
                                  std::vector<double> times,
                                  double liquidity_horizon,
                                  ...
                                  bool hedge = true,
                                  size_t n_threads = std::thread::hardware_concurrency());
        arma::cube component_loss(std::vector<size_t> scenarios_ids,
                                  size_t n_replenishment,
                                  size_t seed,
                                  std::vector<double> times,
                                  double liquidity_horizon,
        ...
        arma::mat total_loss(size_t n,
                             ...
                             bool hedge = true,
                             size_t n_threads = std::thread::hardware_concurrency());
        arma::mat total_loss(std::vector<size_t> scenarios_ids,
                             size_t n_replenishment,
                             size_t seed,
                             std::vector<double> times,
                             double liquidity_horizon,
