...
class CMakeBuild(build_ext):
    def build_extension(self, ext):
        ...
        # from Python.
        cmake_args = [
            "-DBUILD_IDL_TESTS=OFF",
            "-DBUILD_IDL_BENCHMARK=OFF",
            "-DBUILD_IDLPY=ON",
        ...
        cmake_args += [f"-DIDLPY_VERSION={self.distribution.get_version()}"]
...
setup(
    ...
    package_data={'idlpy': ['libopenblas.dll']}
)
